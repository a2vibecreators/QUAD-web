  ...
  parts: [
    ...
    },
    {
      ...
      categories: [
        ...
        {
          key: "quadAlgorithms",
          name: "QUAD Algorithms (FLUX)",
          description: "Intelligent AI routing algorithms - no vendor lock-in, smart routing, cost optimization",
          features: [
            { key: "multiAiRouting", name: "FLUX Routing Algorithm", description: "Route to Claude, OpenAI, Gemini based on task complexity", isDemo: true },
            { key: "providerAgnostic", name: "Provider Agnostic Architecture", description: "No lock-in to single AI vendor", isDemo: true },
            { key: "tokenOptimization", name: "Token Cost Algorithm", description: "Simple tasks → cheap models, complex → premium", isDemo: true },
            { key: "aiFailover", name: "Failover Algorithm", description: "If Claude is down, auto-route to OpenAI", isDemo: true },
            { key: "costMatrix", name: "Cost Matrix Algorithm", description: "Provider × Task → optimal cost routing", isDemo: false },
            { key: "futureProviders", name: "Future Provider Ready", description: "Add Llama, Mistral with zero code changes", isDemo: true },
            { key: "byokSupport", name: "BYOK (Bring Your Own Key)", description: "Use your own AI API keys for control", isDemo: false },
            { key: "aiUsageDashboard", name: "AI Usage Dashboard", description: "Track costs per provider, per agent, per team", isDemo: true },
          ],
        },
        {
          key: "quadOrbit",
          name: "QUAD ORBIT (Cloud Strategy)",
          description: "Deploy anywhere - AWS, GCP, Azure, or hybrid. No cloud vendor lock-in.",
          features: [
            { key: "cloudAgnostic", name: "ORBIT Deployment Engine", description: "Run on AWS, GCP, Azure, or on-prem", isDemo: true },
            { key: "multiCloudSupport", name: "Multi-Cloud Orchestration", description: "Different services on different clouds", isDemo: true },
            { key: "hybridCloud", name: "Hybrid Cloud Bridge", description: "Cloud + on-prem for sensitive data", isDemo: true },
            { key: "awsIntegration", name: "AWS Native Connector", description: "ECS, Lambda, S3, Bedrock support", isDemo: true },
            { key: "gcpIntegration", name: "GCP Native Connector", description: "Cloud Run, GKE, Vertex AI support", isDemo: false },
            { key: "azureIntegration", name: "Azure Native Connector", description: "AKS, Azure OpenAI, Blob support", isDemo: false },
            { key: "cloudCostOptimization", name: "Cloud Cost Analyzer", description: "Compare costs across clouds", isDemo: true },
            { key: "dataSovereignty", name: "Data Sovereignty Controls", description: "Choose where your data lives", isDemo: true },
          ],
        },
      ],
    },
